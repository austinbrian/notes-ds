...
drinks = pd.read_table('https://raw.githubusercontent.com/josephofiowa/GA-DSI/master/example-lessons/plotting-with-pandas/drinks.csv', sep=',')
...
drinks.continent.value_counts() # North America is missing
...
users.sort_values(by=['age','occupation']) # or by multiple variables
